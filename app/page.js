...
export default function Home() {
  return (
    <div className="w-[1769px] h-[1151px] relative bg-gradient-to-b from-[#db4439] to-[#75241e] overflow-hidden">
      ...
      <div className="w-[543px] h-[590px] left-[1068px] top-[226px] absolute rotate-0">
        <div className="w-[543px] h-[590px] absolute bg-[#d9d9d9] rounded-lg shadow-lg" />
        <img 
          className="w-[543px] h-[590px] absolute object-cover rounded-lg" 
          src="https://th.bing.com/th/id/OIP.sxphRAolK5Q42_BPVPpH7AHaE8?rs=1&pid=ImgDetMain" 
          alt="Coffee Cup"
        />
      </div>
      ...
      <div className="left-[64px] top-[46px] absolute justify-start text-[#eaecd7] text-2xl font-bold font-['Inknut_Antiqua']">Order</div>
      ...
      <div className="left-[124px] top-[1063px] absolute justify-start text-[#db4439] text-2xl font-black font-['Inknut_Antiqua'] leading-[29.28px]">Customer Information</div>
      <div className="left-[794px] top-[1063px] absolute justify-start text-[#db4439] text-2xl font-black font-['Inknut_Antiqua'] leading-[29.28px]">Policy</div>
      <div className="left-[1464px] top-[1063px] absolute justify-start text-[#db4439] text-2xl font-black font-['Inknut_Antiqua'] leading-[29.28px]">Purchase Now</div>
    </div>
  );
}